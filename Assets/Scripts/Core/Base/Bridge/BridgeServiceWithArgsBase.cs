...
{
    public abstract class BridgeServiceWithArgsBase<TLogicService, TUIService, TModuleConfig> 
        : BridgeServiceBase<TLogicService, TUIService, TModuleConfig>, IModuleArgsSetter
